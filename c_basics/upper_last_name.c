...
int main() {
    ...
    char guessedWord[] = "_______"; // Initialize to underscores, one for each letter in wordToGuess
    ...
    while (1) {
        ...
        scanf(" %c", &guess); // Notice the space before %c to consume the newline character from the previous input
